...
public class QueuePasienMain19 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        System.out.print("Masukkan kapasitas antrian: ");
        int capacity = sc.nextInt();
        QueuePasien19 antrian = new QueuePasien19(capacity);
        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    Pasien19 pb = new Pasien19(nama, noID, jenisKelamin, umur);
                    sc.nextLine();
                    antrian.enqueue(pb);
                    break;
                case 2:
                    Pasien19 pasienHapus = antrian.dequeue();
                    if (pasienHapus != null) {
